...
PRESETS: list[PrimePlayer] = [
    ...
    PrimePlayer(id="primekor-21", teamId="kor", name="JO Hyeonwoo", label="2019-2022", age=34, height=189, leftFoot=3, rightFoot=5, attributes=GoalkeepingBlock(90)),
    ...
    PrimePlayer(id="primersa-1", teamId="rsa", name="WILLIAMS Ronwen", label="2024", age=34, height=184, leftFoot=5, rightFoot=2, attributes=GoalkeepingBlock(90)),
    ...
    PrimePlayer(id="primefra-1", teamId="fra", name="Brice Samba", label="2022-2023", age=31, height=187, leftFoot=5, rightFoot=3, attributes=GoalkeepingBlock(90)),
    ...
    PrimePlayer(id="primeeng-1", teamId="eng", name="Jordan Pickford", label="2018", age=31, height=187, leftFoot=5, rightFoot=3, attributes=GoalkeepingBlock(90)),
    ...
    PrimePlayer(id="primearg-23", teamId="arg", name="Emiliano Martinez", label="2022", age=33, height=193, leftFoot=3, rightFoot=5, attributes=GoalkeepingBlock(90)),
    ...
    PrimePlayer(id="primebel-1", teamId="bel", name="Thibaut Courtois", label="2018", age=33, height=200, leftFoot=5, rightFoot=3, attributes=GoalkeepingBlock(90)),

    # MAR
    PrimePlayer(id="primemar-1", teamId="mar", name="Yassine Bounou", label="2022", age=34, height=195, leftFoot=5, rightFoot=2, attributes=GoalkeepingBlock(90)),
    ...
    # NOR
    PrimePlayer(id="primenor-1", teamId="nor", name="Orjan Nyland", label="2018-2020", age=35, height=192, leftFoot=2, rightFoot=5, attributes=GoalkeepingBlock(90)),
