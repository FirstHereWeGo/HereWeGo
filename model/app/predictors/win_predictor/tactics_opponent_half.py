...
def apply_opponent_half(tc: TacticConfig, context: TeamContext) -> float:
    ...
    if crossing == "high":
        ...
        if st_height_avg >= 185 and st_strength_avg >= 12:
            ...
            _record_penalty(context, "공중 경합을 받을 타깃 스트라이커의 신장/몸싸움이 부족함")
    ...
    if crossing == "low":
        ...
        if low_cross_score < 0:
            ...
            _record_penalty(context, "로우 크로스에 필요한 침투/결정력이 부족함")
    ...
    if early_crosses:
        ...
        if wing_pass_avg >= 11 and wing_vision_avg >= 11 and st_pos_avg >= 11:
            ...
            _record_penalty(context, "얼리 크로스를 넣을 측면 전개와 박스 침투 타이밍이 부족함")
            rating_adjustment -= 16.0
    ...
    if dribble_more:
        ...
        if atk_drib_avg >= 15 and atk_agil_avg >= 15:
            ...
            _record_penalty(context, "드리블 전개를 맡기기엔 공격진의 드리블/민첩성이 부족함")
    ...
    if play_calmly:
        ...
        if atk_vision_avg >= 13 and atk_passing_avg >= 13 and atk_pos_avg >= 13:
            ...
            _record_penalty(context, "침착한 전개에 필요한 시야/패스/위치선정이 부족함")
            rating_adjustment -= 16.0
    ...
    if play_for_freedom:
        ...
        if team_vision_avg >= 15 and team_pos_avg >= 15:
            ...
            _record_penalty(context, "자유로운 전술을 받쳐줄 전체 시야/위치선정 수준이 부족함")
